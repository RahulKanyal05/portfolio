    ...
    >
      ...
      >
        ...
        <div className="lg:col-span-7 space-y-8">
          ...
          >
            I’m Rahul Kanyal, a B.Tech graduate from Graphic Era Hill University with 2+ years
            of hands-on experience in software development. I specialize in building modern web
            applications using React, Node.js, and AI-powered tools. I’ve completed multiple
            real-world projects and worked as an AI Research Intern at Insignia Consultancy
            Solution, where I gained practical experience in applied AI systems.
          </motion.p>
        </div>
        ...
        <div className="lg:col-span-5 grid grid-cols-2 gap-4">
          {[
            ...
            { label: "Internship", val: "AI Research" },
            { label: "Focus", val: "Fullstack" },
          ]
            .map((stat, i) => (
              <motion.div
                key={i}
